...
const GOOGLE_MAPS_URL =
  "https://www.google.com/maps/place/4+Your+Nails/@37.9315647,23.7547252,17z/";
const ADDRESS = "Λεωφ. Σοφοκλή Βενιζέλου 93, Ηλιούπολη 163 46";
...
export function AnimatedMap() {
  ...
  return (
    <a
      ...
      ref={containerRef}
      className="relative block h-full cursor-pointer select-none"
    ...
    >
        <motion.div
          className="relative w-full h-full min-h-72 overflow-hidden bg-background"
          style={{
